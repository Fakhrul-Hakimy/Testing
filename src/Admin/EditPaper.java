...
public class EditPaper {
    ...
    public void testAcceptPaper() throws InterruptedException {
        ...
        driver.findElement(By.xpath("/html/body/div[2]/div/div[2]/div/div[3]/a[4]/button")).click();
        Thread.sleep(1000);
        
        driver.findElement(By.xpath("/html/body/div[8]/div/div/form/input[1]")).clear();
        Thread.sleep(1000);
        
        driver.findElement(By.xpath("/html/body/div[8]/div/div/form/input[1]")).sendKeys("Edit Paper title");
        Thread.sleep(1000);
        driver.findElement(By.xpath("/html/body/div[8]/div/div/form/textarea")).clear();
        Thread.sleep(1000);
        driver.findElement(By.xpath("/html/body/div[8]/div/div/form/textarea")).sendKeys("Edit Paper abstract");
        Thread.sleep(1000);
        
        driver.findElement(By.xpath("/html/body/div[8]/div/div/form/input[4]")).clear();
        Thread.sleep(1000);
        
        driver.findElement(By.xpath("/html/body/div[8]/div/div/form/input[4]")).sendKeys("Testing , Testcase");
        Thread.sleep(1000);
        
      
        
        driver.findElement(By.xpath("/html/body/div[8]/div/div/form/p/button")).click();
        Thread.sleep(1000);
